...
| **CAPITAL-EFFICIENCY STANDING v2** (2026-07-06, assembly with the promoted trend book) | The deployable book (BLEND50_CONF, full stack + tp_as_limit) runs at just **7.0% ann vol at unit weights** — leverage to a vol target is cheap: **@15% vol (x2.1): 21.9% CAGR, dMDD −8.1%; @25% (x3.6): 37.4% CAGR, Sh 1.49, dMDD −13.4%, worst day −5.1%, IS 1.43 → OOS 1.52; @50% (x7.2): 77.5% CAGR, dMDD −26.0%, worst day −10.1%**. The x3.6 gross at 25% is far from liquidation on any historical day. 3-sleeve assembly v2 (info only — sleeves still blocked): IV weights shift toward trend (0.22/0.11/0.66), @25% 42.5% CAGR / Sh 1.50 / OOS 1.91. | assemble_v2.py |
